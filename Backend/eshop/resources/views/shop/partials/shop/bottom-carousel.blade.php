<section class="py-4 border-top">
    <div class="container px-3">
        <div class="d-flex justify-content-center gap-2 mb-4">
            <button class="btn btn-custom btn-sm active" type="button">Best sellers</button>
            <button class="btn btn-custom btn-sm" type="button">Sales</button>
            <button class="btn btn-custom btn-sm" type="button">New products</button>
        </div>
