...
<nav class="border-bottom py-3 nav-custom">
    <div class="container px-3">
        <div class="row row-cols-7 g-2 text-center">
            ...
            <div class="col">
                <a href="{{ route('categories.show', ['category' => 'sale']) }}" class="text-decoration-none d-flex flex-column align-items-center">
                    <img src="{{ asset('images/icons/nav_bar_sales.png') }}" alt="Sale" class="nav-icon mb-1">
                    <small>Sale</small>
                </a>
            </div>

            <div class="col">
                <a href="{{ route('categories.show', ['category' => 'brands']) }}" class="text-decoration-none d-flex flex-column align-items-center">
                    <img src="{{ asset('images/icons/nav_bar_brands.png') }}" alt="Brands" class="nav-icon mb-1">
                    <small>Brands</small>
                </a>
            </div>
